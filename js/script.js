...
function loadDressupScene(gameContainer) {
    ...
    createSkinColorButtonsAndMakeThemChangeSkinTone(gameContainer, body, elementContainerLeft);
...
function changeEyeStyle(elementContainerLeft, eyes) {
  ...
  eyes1.addEventListener("click", () => setEyeNumber(eyes1));

  const eyes2 = document.createElement("div");
  eyes2.className = "eyes-sort";
  eyes2.addEventListener("click", () => setEyeNumber(eyes2));

  const eyes3 = document.createElement("div");
  eyes3.className = "eyes-sort";
  eyes3.addEventListener("click", () => setEyeNumber(eyes3));
  ...
  function setEyeNumber(clickedElement) {
    if (clickedElement === eyes1) {
      eyes.src = "./images/eyes/eyes1_1.png";
      eyestyle = "1"
    }
    if (clickedElement === eyes2) {
      eyes.src = "./images/eyes/eyes2_1.png";
      eyestyle = "2"
    }
    if (clickedElement === eyes3) {
...
function createSkinColorButtonsAndMakeThemChangeSkinTone(gameContainer, body, elementContainerLeft) {
